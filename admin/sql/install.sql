...
INSERT IGNORE INTO `#__sdrsssyndicator` (`id`, `msg`, `defaultType`, `count`, `orderby`, `numWords`, `cache`, `imgUrl`, `renderHTML`, `categoryItem`, `FPItemsOnly`,`tp`) VALUES (1,'Get the latest news direct to your desktop','YANDEX','10','rdate',0,1,'',1,2,0,4);