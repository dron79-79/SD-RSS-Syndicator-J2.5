...
if($save_file)
{
    $save_path =JPATH_ROOT .DS. "components".DS."com_sdrsssyndicator".DS."assets".DS."images".DS."buttons";
    ...
    {
        exit('Image saved! link: <a href="'.JURI::root().'components/com_sdrsssyndicator/assets/images/buttons/'.$img_name.'" title="'.$img_name.'">'.JURI::root().'components/com_sdrsssyndicator/assets/images/buttons/'.$img_name.'</a>');
    }
    else
    {
