...
class sdrsssyndicatorViewFeed extends JView
{
	function display($tpl = null)
	{
		...
		//$lists['cat2klist'] = JHTML::_( 'select.genericList',$catK2Options, 'msg_k2catlist' . '[]', ' class="inputbox"  style="width: 500px;" multiple="true" size="45""', 'value', 'text', $CatK2Selected );
    ...
    $FPItemsOnly[] = JHTML::_( 'select.option', '1','Статьи опубликованные на главной');
	  ...
	  $lists['renderPublishedList'] = JHTML::_( 'select.genericList', $yesNoList, 'published', 'class="inputbox"','value', 'text',$isNew ? NULL : $feed->published);
		...
		//Section list
		//$sectOptions[] = JHTML::_('select.option', "","Все разделы");
		//$sectOptions[] = JHTML::_('select.option', "0","Не категоризированные");
		...
		$button_path = JPATH_ROOT .DS. "components".DS."com_sdrsssyndicator".DS."assets".DS."images".DS."buttons";
